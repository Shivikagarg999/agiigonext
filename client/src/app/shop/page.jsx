            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
              {filteredProducts.map((product) => (
                <a 
                  ...
                  className="bg-white rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-orange-200 group flex flex-col h-full transform hover:-translate-y-1 hover:shadow-xl"
                >
                  <div className="aspect-[4/5] w-full bg-gray-50 relative overflow-hidden rounded-t-xl">
                    <img
                      src={product.image}
                      alt={product.name}
                    ...
                    />
                    {product.discount > 30 && (
                      <div className="absolute top-3 left-3 bg-red-600 text-white text-xs font-bold px-3 py-1 rounded-lg shadow-md">
                  ...
                  <div className="p-4 flex-1 flex flex-col">
                    ...
                    <h3 className="text-base font-semibold text-gray-900 line-clamp-2 leading-tight mb-3 group-hover:text-[#EB8426] transition-colors">
                      {product.name}
                    </h3>
