...
export default function Nav() {
  ...
  const [isSeller, setIsSeller] = useState(true);  // Assume user is a seller for now, you'll likely get this from a context or cookie
    ...
    <nav className="bg-white py-5 shadow-md">
      <div className="container mx-auto flex justify-between items-center px-6">
        ...
        <a href="#" className="text-2xl font-bold text-[#EB8426]">
          <img src="/images/logo.jpg" className="h-8" alt="Logo"></img>
        </a>
        ...
        <ul className="hidden lg:flex items-center space-x-8 text-lg font-semibold">
          ...
          {isSeller && (
            <li><a href="/my-products" className="text-gray-700 hover:text-black">My Products</a></li>
          )}
        </ul>

        {/* Right Section (Icons & Login/Logout) */}
      ...
      {isOpen && (
        <div className="lg:hidden bg-white shadow-md py-4 px-6">
          <ul className="flex flex-col space-y-4 text-lg font-semibold">
            ...
            {/* Seller-specific link in mobile */}
            {isSeller && (
              <li><a href="/my-products" className="text-gray-700 hover:text-black">My Products</a></li>
            )}
